        ...
        <div className='shadow-md'>
            <div className='flex items-center justify-between px-8 py-4 max-w-7xl mx-auto'>
                <div className='flex items-center'>
                    <img className='h-10' src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Airbnb_Logo_B%C3%A9lo.svg/1200px-Airbnb_Logo_B%C3%A9lo.svg.png" alt="Logo do projeto" />
                    <p className='text-1xl font-bold text-primary-green'>.fullstackproject</p>
                </div>
